...
#encoder
encoder = SentenceTransformer('danjohnvelasco/filipino-sentence-roberta-v1')
table_name = 'kdww_season_faqs_tl'
...
# Streamlit UI 설정
#st.set_page_config(page_title="늑칼 Season(tl)")
st.image("assets/seasons_tl_30.png", caption="Filipino")
